...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=wonjoyoo&repo=hello",
  "projectName" : "hello",
  "repositoryPrefix" : "tanzukr.azurecr.io"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->tanzukr.azurecr.io]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=wonjoyoo&repo=hello'
